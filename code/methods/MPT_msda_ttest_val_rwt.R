...
MPT_ttest_msda_rwt_val = function(vec_X1, vec_X2, N1, N2, mu1, mu2, dsigma, sigma, 
  ...
  for (mm in 1:M){
    ...
    tmp = SPT_ttest_msda_rwt_val(vec_X1[perms1[mm,],], vec_X2[perms2[mm,],], N1, N2, 
                                  mu1, mu2, dsigma, sigma, 
                                  lambda.list, type=type, df=df, 
